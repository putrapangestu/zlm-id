    ...
    <form action="{{ route('admin.articles.update', $article->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-200/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 sm:p-8 space-y-6">
            <div class="flex items-center justify-between pb-3 border-b border-gray-100">
                ...
                <span class="text-[11px] font-mono text-gray-400">Slug: /articles/{{ $article->slug }}</span>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $article->name) }}" required
                ...
                <div>
                    ...
                    <input type="date" id="date" name="date" value="{{ old('date', $article->date ? $article->date->format('Y-m-d') : date('Y-m-d')) }}" required
                        class="w-full bg-gray-50 border border-gray-200 text-sm text-[#363230] rounded-xl py-2.5 px-4 focus:outline-none focus:border-[#DF5E1D]/40 focus:ring-2 focus:ring-[#DF5E1D]/10 transition-all">
                </div>
                ...
                <div class="flex items-center pt-6">
                    <label class="relative flex items-center gap-3 cursor-pointer">
                        ...
                        <span class="text-xs font-bold text-[#363230]">Publikasikan ke Pengunjung</span>
                    </label>
                </div>

                <!-- Gambar Thumbnail / Cover Saat Ini & Upload Baru -->
                <div class="md:col-span-2">
                    ...
                    @if($article->thumbnail)
                        <div class="flex items-center gap-4 mb-3 p-3 bg-gray-50 rounded-xl border border-gray-200/60 w-fit">
                            <img src="{{ $article->thumbnail_url_full }}" alt="" class="w-20 h-14 object-cover rounded-lg">
                    ...
                    <p class="text-[11px] text-gray-400 mt-1">Biarkan kosong jika tidak ingin mengubah thumbnail.</p>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="excerpt" name="excerpt" rows="2"
                        class="w-full bg-gray-50 border border-gray-200 text-xs text-[#363230] rounded-xl p-3 focus:outline-none focus:border-[#DF5E1D]/40 focus:ring-2 focus:ring-[#DF5E1D]/10 transition-all resize-none">{{ old('excerpt', $article->excerpt) }}</textarea>
                </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea id="meta_description" name="meta_description" rows="2"
                        ...
                        placeholder="Deskripsi ringkas untuk snippet pencarian Google (150-160 karakter disarankan)...">{{ old('meta_description', $article->meta_description) }}</textarea>
                </div>
