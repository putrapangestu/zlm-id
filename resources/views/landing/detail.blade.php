                ...
                <div class="p-8 lg:p-14 flex flex-col justify-center bg-gradient-to-br from-gray-50/50 to-white">
                    ...
                    <label for="zoom-image" class="relative w-full aspect-square md:aspect-[4/3] lg:aspect-square flex items-center justify-center bg-white rounded-2xl border border-gray-200/50 shadow-sm overflow-hidden mb-6 group cursor-zoom-in transition-all duration-300 hover:border-gray-300 hover:shadow-md">
                        @if ($product->image_url)
                            <img src="{{ $product->image_url }}" alt="{{ $product->name }}" class="w-full h-full object-contain p-8 mix-blend-multiply transition-transform duration-700 ease-out group-hover:scale-110">
                        @else
                            <img src="https://images.unsplash.com/photo-1593642632823-8f785ba67e45?auto=format&fit=crop&q=80&w=1200" alt="{{ $product->name }}" class="w-full h-full object-cover transition-transform duration-700 ease-out group-hover:scale-110">
                        @endif
                    ...
                    <div class="fixed inset-0 z-50 bg-white/95 backdrop-blur-xl opacity-0 pointer-events-none peer-checked:opacity-100 peer-checked:pointer-events-auto transition-all duration-500 flex items-center justify-center">
                        ...
                        <div class="relative w-full max-w-5xl max-h-[90vh] p-4 scale-95 peer-checked:scale-100 transition-transform duration-500 ease-out z-0">
                            ...
                            @else
                                <img src="https://images.unsplash.com/photo-1593642632823-8f785ba67e45?auto=format&fit=crop&q=80&w=1200" alt="{{ $product->name }}" class="w-full h-full object-contain rounded-xl shadow-2xl">
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="flex items-end justify-between mb-10 pb-10 border-b border-gray-100">
                        <div class="flex flex-col gap-1">
                            ...
                            <div class="flex items-baseline gap-2">
                                <span class="text-4xl font-medium tracking-tight text-[#363230]">Rp{{ number_format($product->price, 0, ',', '.') }}</span>
                            </div>
                        </div>
                    ...
                    @foreach ($similar as $product)
                        <div class="bg-white rounded-2xl border border-gray-200/60 shadow-sm hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:-translate-y-1.5 transition-all duration-400 overflow-hidden flex flex-col group relative">
                            ...
                            <a href="{{ route('landing.detail', $product->id) }}" class="relative h-56 bg-gradient-to-b from-gray-50 to-white overflow-hidden flex items-center justify-center border-b border-gray-100">
                                @if ($product->image_url)
                                    <img src="{{ $product->image_url }}" alt="{{ $product->name }}" class="w-full h-full object-cover mix-blend-multiply group-hover:scale-110 transition-transform duration-700 ease-out">
                                @else
