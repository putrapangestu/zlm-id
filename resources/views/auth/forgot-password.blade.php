...
<head>
    ...
    <title>Lupa Password — ZLM.ID</title>
...
<body class="bg-gray-50 text-gray-800 selection:bg-[#DF5E1D] selection:text-white min-h-screen">
    ...
    <div class="min-h-screen flex">
        <!-- Left Panel - Branding -->
        <div class="hidden lg:flex lg:w-1/2 forgot-gradient relative overflow-hidden">
            <!-- Decorative Elements -->
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
            <div class="w-full max-w-md">
                ...
                <!-- Header -->
                <div class="mb-8">
                    <h1 class="text-2xl font-semibold text-[#363230] mb-2">Lupa Password</h1>
                    <p class="text-gray-500 text-sm">Masukkan email Anda, kami akan kirimkan kode OTP untuk mereset password</p>
                </div>

                <!-- Session Status -->
                @if (session('status'))
                    <div class="mb-6 p-4 bg-green-50 border border-green-200 rounded-xl flex items-start gap-3">
                        <iconify-icon icon="solar:check-circle-bold" class="text-green-500 text-xl mt-0.5"></iconify-icon>
                ...
                <form method="POST" action="{{ route('password.email') }}" class="space-y-5">
                    ...
                    >
                        <iconify-icon icon="solar:send-square-linear" class="text-lg"></iconify-icon>
                        Kirim Kode OTP
                    </button>
                </form>
