    ...
    <div class="min-h-screen flex">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
            <div class="w-full max-w-md">
                ...
                <!-- Header -->
                <div class="mb-8">
                    <h1 class="text-2xl font-semibold text-[#363230] mb-2">Masuk ke Akun Anda</h1>
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input
                                ...
                                class="w-4 h-4 rounded border-gray-300 text-[#DF5E1D] focus:ring-[#DF5E1D] focus:ring-offset-0 transition"
                            >
                            <span class="text-sm text-gray-600">Ingat saya</span>
                        </label>

                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-sm text-[#DF5E1D] hover:text-[#c45218] font-medium transition">
                                Lupa password?
                            </a>
                        @endif
                    </div>
                ...
                <div class="mt-8 text-center">
                    <p class="text-sm text-gray-500">
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="text-[#DF5E1D] hover:text-[#c45218] font-medium transition">
                                Daftar sekarang
                            </a>
                        @endif
                    </p>
